...
final class Moves {
	...
	public static final int eom = 36;
	...
	static final boolean[][] ckmv = new boolean[37][36];
	static final boolean[][] ckmv2 = new boolean[29][28];
	static final boolean[][] ckmv3 = new boolean[21][20];
	static {
		for (int i=0; i<29; i++) {
